...
public class EditarPacSC extends javax.swing.JFrame {

    ControladoraLogica control = null;
    PacienteSC pacSC = new PacienteSC();
    
    public EditarPacSC(int idPacSC) {
        control = new ControladoraLogica();
        initComponents();
        cargarObservPacSC(idPacSC);
    }
    ...
    private void btnVolverActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnVolverActionPerformed
        this.dispose();
        PacientesSCEnfermeros pacSC = new PacientesSCEnfermeros();
    ...
    private void btnEditarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnEditarActionPerformed
        ...
        control.editarPacSC(pacSC, observaciones);
        mostrarMensaje("Edición realizada correctamente", "Info", "Edición exitosa");
        PacientesSCEnfermeros verPacSCEnf = new PacientesSCEnfermeros();
        verPacSCEnf.setVisible(true);
        verPacSCEnf.setLocationRelativeTo(null);
        this.dispose();
    ...
    private void cargarObservPacSC(int idPacSC) {
