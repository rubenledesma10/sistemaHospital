...
public class NuevoPacienteSC extends javax.swing.JFrame {

    ControladoraLogica control = new ControladoraLogica();
    public NuevoPacienteSC() {
        initComponents();
    }
    ...
    private void btnLimpiarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnLimpiarActionPerformed
        ...
        txtDNI.setText("");
        txtCama.setText("");
        dateFechaActual.setDateFormatString("");
    ...
    private void btnIngresarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnIngresarActionPerformed
        ...
        control.nuevoPacSC(nombre, apellido, dni, cama, fecha, observaciones);
        mostrarMensaje("Nuevo paciente ingresado correctamente", "Info", "Nuevo paciente agregado exitosamente");
        txtNombre.setText("");
        txtApellido.setText("");
        txtDNI.setText("");
        txtCama.setText("");
