...
public class EditarPacTIMed extends javax.swing.JFrame {

    ControladoraLogica control = null;
    PacienteTI pacTI = new PacienteTI();

    public EditarPacTIMed(int idPacTi) {
        control = new ControladoraLogica();
        initComponents();
        cargarDatosPaciente(idPacTi);
    }
    ...
    private void initComponents() {
        ...
        jLabel8.setIcon(new javax.swing.ImageIcon("C:\\Users\\ledes\\OneDrive\\Escritorio\\Facultad\\Programacion\\TodoCode\\4. Java\\SistemaHospital\\Recursos\\terapiaintensiva.png")); // NOI18N
    ...
    private void btnEditarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnEditarActionPerformed
        ...
        control.editarPacTIMed(pacTI, nombre, apellido, dni, cama, fecha, observaciones);
        mostrarMensaje("Edicion realizada correctamente", "Info", "Edicion exitosa");
        PacientesTIMedicos pacTI = new PacientesTIMedicos();
    ...
    private void cargarDatosPaciente(int idPacTi) {
        pacTI = control.traerPacTI(idPacTi);
        txtNombre.setText(pacTI.getNombre());
        txtApellido.setText(pacTI.getApellido());
        txtDNI.setText(pacTI.getDni());
        txtCama.setText(String.valueOf(pacTI.getCama()));
        SimpleDateFormat formatoFecha = new SimpleDateFormat("dd/MM/yyyy HH:mm:ss");
        try {
            dateFechaActual.setDate(formatoFecha.parse(pacTI.getFechaIngreso()));
        } catch (ParseException ex) {
            Logger.getLogger(EditarPacTIMed.class.getName()).log(Level.SEVERE, null, ex);
        }
        txtObservaciones.setText(pacTI.getObservaciones());
    }
}
