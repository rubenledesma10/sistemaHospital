...
public class EditarPacTI extends javax.swing.JFrame {
    
    ControladoraLogica control = null;
    PacienteTI pacTI = new PacienteTI();
    public EditarPacTI(int idPacTI) {
        control = new ControladoraLogica();
        initComponents();
        cargarObservPacTI(idPacTI);
    }
    ...
    private void btnEditarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnEditarActionPerformed
        ...
        control.editarPacTI(pacTI, observaciones);
        mostrarMensaje("Edición realizada correctamente", "Info", "Edición exitosa");
        PacientesTIEnfermeros verPacTIEnf = new PacientesTIEnfermeros();
        verPacTIEnf.setVisible(true);
        verPacTIEnf.setLocationRelativeTo(null);
        this.dispose();
    ...
    private void cargarObservPacTI(int idPacTI) {
